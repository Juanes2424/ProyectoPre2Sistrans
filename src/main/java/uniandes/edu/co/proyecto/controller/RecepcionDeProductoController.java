...
public class RecepcionDeProductoController {
    ...
    public ResponseEntity<Map<String, Object>> obtenerDocumentosIngreso(
        ...
        @GetMapping("/documentos/rfc7/{idSucursal}/{idBodega}")
    public ResponseEntity<Map<String, Object>> obtenerDocumentosIngreso2(
            @PathVariable Long idSucursal,
            @PathVariable Long idBodega) {
        try {
            List<Object[]> resultados = recepcionDeProductoService.obtenerDocumentosIngreso2(idSucursal, idBodega);
